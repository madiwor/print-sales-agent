      ...
      <aside className="w-56 shrink-0 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="font-semibold text-gray-900 leading-tight">Madiwor</div>
              <div className="text-[10px] text-gray-400 uppercase tracking-widest leading-tight">Superadmin</div>
            </div>
          </div>
        </div>
        ...
        <nav className="flex flex-col gap-0.5 p-3 flex-1">
          ...
          <NavLink href="/superadmin/portales">
          ...
          <NavLink href="/superadmin/sessions">
        ...
        <div className="px-4 py-3 border-t border-gray-100">
          <p className="text-xs text-gray-400">Madiwor Admin</p>
        </div>
      </aside>
